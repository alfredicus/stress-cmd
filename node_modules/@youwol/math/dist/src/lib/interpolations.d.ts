 ...
 * @category Interpolation
 */
export declare function triangleLerp2D(p: V2, p1: V2, p2: V2, p3: V2, q1: number | number[], q2: number | number[], q3: number | number[]): number | number[];
/**
 * @param q1 Either a number or an array of size 3, 6 or 9 defined at point p1
 * @param q2 Either a number or an array of size 3, 6 or 9 defined at point p2
 * @param q3 Either a number or an array of size 3, 6 or 9 defined at point p3
 * @category Interpolation
 */
export declare function triangleLerp3D(p: V3, p1: V3, p2: V3, p3: V3, q1: number | number[], q2: number | number[], q3: number | number[]): number | number[];
/**
 * @param q1 Either a number or an array of size 3, 6 or 9 defined at point p1
 * @param q2 Either a number or an array of size 3, 6 or 9 defined at point p2
 * @param q3 Either a number or an array of size 3, 6 or 9 defined at point p3
 ...
 * @category Interpolation
 */
export declare function tetraLerp(p: V3, p1: V3, p2: V3, p3: V3, p4: V3, q1: number | number[], q2: number | number[], q3: number | number[], q4: number | number[]): number | number[];
/**
