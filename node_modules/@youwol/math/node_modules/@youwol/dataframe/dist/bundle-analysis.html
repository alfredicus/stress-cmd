...
<html>
  <head>
    ...
    <title>@youwol/dataframe [12 Oct 2023 at 10:10]</title>
...
//# sourceMappingURL=viewer.js.map</script>
  ...
  <body>
    <div id="app"></div>
    <script>
      window.chartData = [{"label":"@youwol/dataframe.js","isAsset":true,"statSize":43339,"parsedSize":13002,"gzipSize":4144,"groups":[{"label":"lib","path":"./lib","statSize":43339,"groups":[{"id":541,"label":"index.ts + 29 modules (concatenated)","path":"./lib/index.ts + 29 modules (concatenated)","statSize":43339,"parsedSize":13002,"gzipSize":4144,"concatenated":true,"groups":[{"label":"lib","path":"./lib/index.ts + 29 modules (concatenated)/lib","statSize":43339,"groups":[{"id":null,"label":"index.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/index.ts","statSize":226,"parsedSize":67,"gzipSize":21,"inaccurateSizes":true},{"id":null,"label":"dataframe.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/dataframe.ts","statSize":5483,"parsedSize":1644,"gzipSize":524,"inaccurateSizes":true},{"id":null,"label":"serie.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/serie.ts","statSize":8711,"parsedSize":2613,"gzipSize":832,"inaccurateSizes":true},{"label":"algorithms","path":"./lib/index.ts + 29 modules (concatenated)/lib/algorithms","statSize":7252,"groups":[{"id":null,"label":"index.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/algorithms/index.ts","statSize":174,"parsedSize":52,"gzipSize":16,"inaccurateSizes":true},{"id":null,"label":"map.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/algorithms/map.ts","statSize":1274,"parsedSize":382,"gzipSize":121,"inaccurateSizes":true},{"id":null,"label":"filter.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/algorithms/filter.ts","statSize":741,"parsedSize":222,"gzipSize":70,"inaccurateSizes":true},{"id":null,"label":"forEach.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/algorithms/forEach.ts","statSize":831,"parsedSize":249,"gzipSize":79,"inaccurateSizes":true},{"id":null,"label":"reduce.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/algorithms/reduce.ts","statSize":2793,"parsedSize":837,"gzipSize":267,"inaccurateSizes":true},{"id":null,"label":"apply.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/algorithms/apply.ts","statSize":741,"parsedSize":222,"gzipSize":70,"inaccurateSizes":true},{"id":null,"label":"sort.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/algorithms/sort.ts","statSize":298,"parsedSize":89,"gzipSize":28,"inaccurateSizes":true},{"id":null,"label":"cut.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/algorithms/cut.ts","statSize":400,"parsedSize":120,"gzipSize":38,"inaccurateSizes":true}],"parsedSize":2175,"gzipSize":693,"inaccurateSizes":true},{"label":"utils","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils","statSize":8212,"groups":[{"id":null,"label":"index.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils/index.ts","statSize":223,"parsedSize":66,"gzipSize":21,"inaccurateSizes":true},{"id":null,"label":"create.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils/create.ts","statSize":3474,"parsedSize":1042,"gzipSize":332,"inaccurateSizes":true},{"id":null,"label":"exists.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils/exists.ts","statSize":142,"parsedSize":42,"gzipSize":13,"inaccurateSizes":true},{"id":null,"label":"info.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils/info.ts","statSize":1007,"parsedSize":302,"gzipSize":96,"inaccurateSizes":true},{"id":null,"label":"arrayUtils.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils/arrayUtils.ts","statSize":2112,"parsedSize":633,"gzipSize":201,"inaccurateSizes":true},{"id":null,"label":"copy.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils/copy.ts","statSize":564,"parsedSize":169,"gzipSize":53,"inaccurateSizes":true},{"id":null,"label":"duplicate.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils/duplicate.ts","statSize":196,"parsedSize":58,"gzipSize":18,"inaccurateSizes":true},{"id":null,"label":"nameOfSerie.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils/nameOfSerie.ts","statSize":304,"parsedSize":91,"gzipSize":29,"inaccurateSizes":true},{"id":null,"label":"getNameSeries.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/utils/getNameSeries.ts","statSize":190,"parsedSize":57,"gzipSize":18,"inaccurateSizes":true}],"parsedSize":2463,"gzipSize":785,"inaccurateSizes":true},{"label":"views","path":"./lib/index.ts + 29 modules (concatenated)/lib/views","statSize":6280,"groups":[{"id":null,"label":"index.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/views/index.ts","statSize":52,"parsedSize":15,"gzipSize":4,"inaccurateSizes":true},{"id":null,"label":"matrix.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/views/matrix.ts","statSize":5008,"parsedSize":1502,"gzipSize":478,"inaccurateSizes":true},{"id":null,"label":"vector.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/views/vector.ts","statSize":1220,"parsedSize":366,"gzipSize":116,"inaccurateSizes":true}],"parsedSize":1884,"gzipSize":600,"inaccurateSizes":true},{"label":"conditional","path":"./lib/index.ts + 29 modules (concatenated)/lib/conditional","statSize":907,"groups":[{"id":null,"label":"index.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/conditional/index.ts","statSize":72,"parsedSize":21,"gzipSize":6,"inaccurateSizes":true},{"id":null,"label":"isNaN.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/conditional/isNaN.ts","statSize":224,"parsedSize":67,"gzipSize":21,"inaccurateSizes":true},{"id":null,"label":"check.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/conditional/check.ts","statSize":99,"parsedSize":29,"gzipSize":9,"inaccurateSizes":true},{"id":null,"label":"if.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/conditional/if.ts","statSize":512,"parsedSize":153,"gzipSize":48,"inaccurateSizes":true}],"parsedSize":272,"gzipSize":86,"inaccurateSizes":true},{"label":"decompose","path":"./lib/index.ts + 29 modules (concatenated)/lib/decompose","statSize":6268,"groups":[{"id":null,"label":"index.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/decompose/index.ts","statSize":98,"parsedSize":29,"gzipSize":9,"inaccurateSizes":true},{"id":null,"label":"manager.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/decompose/manager.ts","statSize":4639,"parsedSize":1391,"gzipSize":443,"inaccurateSizes":true},{"id":null,"label":"functional-decomposer.ts","path":"./lib/index.ts + 29 modules (concatenated)/lib/decompose/functional-decomposer.ts","statSize":1531,"parsedSize":459,"gzipSize":146,"inaccurateSizes":true}],"parsedSize":1880,"gzipSize":599,"inaccurateSizes":true}],"parsedSize":13002,"gzipSize":4144,"inaccurateSizes":true}]}],"parsedSize":13002,"gzipSize":4144}]}];
